...
void main() {
  ...
  group('Configuration', () {
    ...
    test('setAdvertiserIdCollectionEnabled forwards false', () async {
      await facebookAppEvents.setAdvertiserIdCollectionEnabled(false);

      expect(
        methodCall,
        isMethodCall('setAdvertiserIdCollectionEnabled', arguments: false),
      );
    });

    test('setAdvertiserIdCollectionEnabled rejects enabling advertiser ID', () {
      expect(
    ...
    test('setAdvertiserTracking rejects advertiser ID collection', () {
      expect(
        () {
          // ignore: deprecated_member_use_from_same_package
          return facebookAppEvents.setAdvertiserTracking(
            enabled: true,
            collectId: true,
          );
        },
    ...
    test(
        'setDataProcessingOptions throws RangeError for values that do not '
        'fit in 32 bits', () {
      expect(
